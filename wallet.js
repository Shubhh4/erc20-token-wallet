...
const Wallet = () => {
	...
	// deploy simple token contract and paste deployed contract address here. This value is local ganache chain taken from remix ide
	...
	// the update account, will cause component re-render
